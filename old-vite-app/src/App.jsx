                                ...
                                <div className="lg:col-span-7 flex flex-col justify-center space-y-10 order-2 lg:order-1 text-center lg:text-left mt-10 lg:mt-0">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center gap-5 pt-2">
                                        ...
                                        <button
                                            ...
                                            className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-bold bg-white hover:bg-slate-50 text-textPrimary border border-gray-200 shadow-sm hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2"
                                        >
                                    ...
                                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 sm:gap-8 pt-8 border-t border-slate-200/60 mt-4">
                                        ...
                                        <div className="flex -space-x-3">
                                            <img className="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="Avatar" />
                                            <img className="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80" alt="Avatar" />
                                            <img className="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&q=80" alt="Avatar" />
                                            ...
                                            >
                                                ...
                                                <div className="p-8 space-y-4 flex-1 flex flex-col justify-between">
                                                    <div className="space-y-3">
                                                        ...
                                                        <h4 className="text-2xl sm:text-2xl sm:text-3xl font-bold text-textPrimary leading-snug group-hover:text-gold-600 transition-colors">
                                                            {hero.title}
                                                        </h4>
                        ...
                        <section className="py-20 bg-white px-6 lg:px-20 border-b border-gray-100">
                            <div className="max-w-7xl mx-auto w-full text-center space-y-12">
                                <div className="space-y-3">
                                    ...
                                    <h3 className="text-xl sm:text-4xl font-bold text-textPrimary">Join the Technical Community</h3>
                                    <p className="text-sm text-textSecondary font-normal max-w-xl mx-auto">
                                ...
                                <article className="prose max-w-none text-textPrimary font-body text-base sm:text-lg leading-relaxed space-y-6">
                                    {selectedArticle.body ? (
                                        selectedArticle.body.split('\n\n').map((para, index) => {
                                            ...
                                            if (para.startsWith('### ')) {
                                                return <h3 key={index} className="text-xl sm:text-xl sm:text-2xl font-bold text-textPrimary pt-4 pb-2 border-b border-slate-100">{para.replace('### ', '')}</h3>;
                                            }
                                            ...
                                            // Paragraph
                                            return <p key={index} className="font-normal text-textSecondary leading-relaxed">{para}</p>;
                                        })
                                    ) : (
                                ...
                                {[
                                    ...
                                    <div key={idx} className="glass-card p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between">
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xl sm:text-2xl font-bold text-textPrimary">{card.count}</p>
